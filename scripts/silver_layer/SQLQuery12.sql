...
/* 2. TABLE 1: 0 to 500k
*/
IF OBJECT_ID('bronze.api_data_aadhar_biometric_0_500000', 'U') IS NOT NULL
    DROP TABLE bronze.api_data_aadhar_biometric_0_500000;
GO

CREATE TABLE bronze.api_data_aadhar_biometric_0_500000 (
    [date]           NVARCHAR(50), 
    [state]          NVARCHAR(255),
...
---------------------------------------
IF OBJECT_ID('bronze.api_data_aadhar_biometric_500000_1000000', 'U') IS NOT NULL
    DROP TABLE bronze.api_data_aadhar_biometric_500000_1000000;
GO

CREATE TABLE bronze.api_data_aadhar_biometric_500000_1000000(
...
---------------------------------------
IF OBJECT_ID('bronze.api_data_aadhar_biometric_1000000_1500000', 'U') IS NOT NULL
    DROP TABLE bronze.api_data_aadhar_biometric_1000000_1500000;
GO

CREATE TABLE bronze.api_data_aadhar_biometric_1000000_1500000(
    [date]           NVARCHAR(50),
    [state]          NVARCHAR(100),
...
---------------------------------------
IF OBJECT_ID('bronze.api_data_aadhar_biometric_1500000_1861108', 'U') IS NOT NULL
    DROP TABLE bronze.api_data_aadhar_biometric_1500000_1861108;
GO

CREATE TABLE bronze.api_data_aadhar_biometric_1500000_1861108 (
    [date]           NVARCHAR(50),
    [state]          NVARCHAR(100),
    [district]       NVARCHAR(100),
    [pincode]        NVARCHAR(20),
